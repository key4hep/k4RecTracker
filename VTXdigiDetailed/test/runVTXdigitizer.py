...
# Import MetadataSvc Configuration
...
# IDEA silicon wrapper (VTXDigiDetailed not tested on IDEA for now)
...
from Configurables import TrackingCellIDEncodingSvc
...
detectors_to_use=[
                    # 'FCCee/IDEA/compact/IDEA_o1_v03/IDEA_o1_v03.xml', #(VTXDigiDetailed not tested on IDEA for now)
                    'FCCee/CLD/compact/CLD_o2_v07/CLD_o2_v07.xml', # This version is considering the branch https://github.com/jessy-daniel/k4geo/tree/Add_pixels_tracker with pixel segmentation (pull request to come)
                  ]
...
SimG4SaveTrackerHitsB.SimTrackHits.Path = "VertexBarrelCollection"

SimG4SaveTrackerHitsE = SimG4SaveTrackerHits("SimG4SaveTrackerHitsE", readoutName="VertexEndcapCollection")
SimG4SaveTrackerHitsE.SimTrackHits.Path = "VertexEndcapCollection"
...
### For CLD
cld_vtxb_digitizer = VTXdigitizerDetailed("VTXBarrelDigitizer",
    inputSimHits = SimG4SaveTrackerHitsB.SimTrackHits.Path,
    outputDigiHits = SimG4SaveTrackerHitsB.SimTrackHits.Path.replace("Collection", "Hits"),
    outputSimDigiAssociation = SimG4SaveTrackerHitsB.SimTrackHits.Path.replace("Collection", "HitRelations"),
    detectorName = "VertexBarrel",
    PixSizePhi = [0.020, 0.020, 0.020, 0.020, 0.020, 0.020],
    PixSizeTheta = [0.020, 0.020, 0.020, 0.020, 0.020, 0.020],
    tResolution = [0.,0.,0.,0.,0.,0.],
    Threshold = 100.0, 
    ThresholdSmearing = 5.0, 
    OutputLevel = WARNING,
    DebugHistos = False,
    DebugFileName = "Debug_VTXBarrelDigitizer.root"
)

cld_vtxd_digitizer = VTXdigitizerDetailed("VTXEndcapDigitizer",
    inputSimHits = SimG4SaveTrackerHitsE.SimTrackHits.Path,
    outputDigiHits = SimG4SaveTrackerHitsE.SimTrackHits.Path.replace("Collection", "Hits"),
    outputSimDigiAssociation = SimG4SaveTrackerHitsE.SimTrackHits.Path.replace("Collection", "HitRelations"),
...
### For IDEA
# idea_vtxb_digitizer = VTXdigitizerDetailed("VTXBdigitizer",
#     inputSimHits = SimG4SaveTrackerHitsB.SimTrackHits.Path,
...
# idea_vtxd_digitizer  = VTXdigitizerDetailed("VTXDdigitizer",
...
# idea_siwrb_digitizer = VTXdigitizerDetailed("SiWrBdigitizer",
...
# idea_siwrd_digitizer = VTXdigitizerDetailed("SiWrDdigitizer",
...
ApplicationMgr(
    ...
    EvtSel = 'NONE',
    EvtMax   = 1000,
    ExtSvc = [metadatasvc, geoservice, cellIDSvc,podioevent, geantservice, audsvc],
    StopOnSignal = True
 )
