...
# Script to setup key4hep nightly envrionment that allows to use (py)torch and onnxruntime together with DD4hep.
source /cvmfs/sw-nightlies.hsf.org/key4hep/setup.sh -r 2025-06-29
