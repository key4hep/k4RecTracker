...
geantservice = SimG4Svc(
    "SimG4Svc", detector="SimG4DD4hepDetector", physicslist="SimG4FtfpBert", magneticField=field
)  # , actions = actions)
...
### IDEA
SimG4SaveTrackerHitsB = SimG4SaveTrackerHits(
    "SimG4SaveTrackerHitsB", readoutName="VertexBarrelCollection"
)
SimG4SaveTrackerHitsB.SimTrackHits.Path = "VTXB_simTrackerHits"

SimG4SaveTrackerHitsD = SimG4SaveTrackerHits(
    "SimG4SaveTrackerHitsD", readoutName="VertexEndcapCollection"
)
SimG4SaveTrackerHitsD.SimTrackHits.Path = "VTXD_simTrackerHits"

SimG4SaveTrackerHitsSiWrB = SimG4SaveTrackerHits(
    "SimG4SaveTrackerHitsSiWrB", readoutName="SiWrBCollection"
)
SimG4SaveTrackerHitsSiWrB.SimTrackHits.Path = "SiWrB_simTrackerHits"

SimG4SaveTrackerHitsSiWrD = SimG4SaveTrackerHits(
    "SimG4SaveTrackerHitsSiWrD", readoutName="SiWrDCollection"
)
...
geantsim = SimG4Alg(
    "SimG4Alg",
    outputs=[
        SimG4SaveTrackerHitsB,
        SimG4SaveTrackerHitsD,
        SimG4SaveTrackerHitsSiWrB,
        SimG4SaveTrackerHitsSiWrD,
        # saveHistTool
    ],
    eventProvider=particle_converter,
    OutputLevel=INFO,
...
### For IDEA
idea_vtxb_digitizer = VTXdigitizer(
    "VTXBdigitizer",
    inputSimHits=SimG4SaveTrackerHitsB.SimTrackHits.Path,
    outputDigiHits=SimG4SaveTrackerHitsB.SimTrackHits.Path.replace("sim", "digi"),
    outputSimDigiAssociation=SimG4SaveTrackerHitsB.SimTrackHits.Path.replace(
        "simTrackerHits", "simDigiAssociation"
    ),
    detectorName="Vertex",
    readoutName="VertexBarrelCollection",
    xResolution=[
...
idea_vtxd_digitizer = VTXdigitizer(
    "VTXDdigitizer",
    ...
    outputSimDigiAssociation=SimG4SaveTrackerHitsD.SimTrackHits.Path.replace(
        "simTrackerHits", "simDigiAssociation"
    ),
    detectorName="Vertex",
    readoutName="VertexEndcapCollection",
...
idea_siwrb_digitizer = VTXdigitizer(
    "SiWrBdigitizer",
    ...
    outputSimDigiAssociation=SimG4SaveTrackerHitsSiWrB.SimTrackHits.Path.replace(
        "simTrackerHits", "simDigiAssociation"
    ),
    detectorName="SiWrB",
...
idea_siwrd_digitizer = VTXdigitizer(
    "SiWrDdigitizer",
    ...
    outputSimDigiAssociation=SimG4SaveTrackerHitsSiWrD.SimTrackHits.Path.replace(
        "simTrackerHits", "simDigiAssociation"
    ),
    detectorName="SiWrD",
