...
TMatrixDSym computeTrackStateCovMatrix(TVectorD stateTrack, TVectorD params, TVector3 referencePoint, double timeError, TMatrixDSym statecovMatrix)
{
  ...
  double dD0_dZ = 0;
  double dD0_dPx = -(referencePoint.X()-pos_0.X())*sin(phi0)*dPhi0_dPx - (referencePoint.Y()-pos_0.Y())*cos(phi0)*dPhi0_dPx;
  double dD0_dPy = -(referencePoint.X()-pos_0.X())*sin(phi0)*dPhi0_dPy - (referencePoint.Y()-pos_0.Y())*cos(phi0)*dPhi0_dPy;
  double dD0_dPz = 0;
